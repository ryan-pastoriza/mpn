...
@section('content')
    @include('pages.dashboard.home-search-statistics')
@endsection
...
@section('scripts')
    ...
    <script src="{{asset('js/custom/popup/pop_form.js')}}"></script>
    <script src="{{asset('js/custom/home/amount-to-words.js')}}"></script>
